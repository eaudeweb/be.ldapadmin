...
class UserInfoSchema(colander.MappingSchema):
    """
    Schema for LDAP user information. Can be used by front-end tools
    to verify data before sending it to `usersdb`. The `usersdb` library
    does very little validation of its own.
    """
    ...
    organisation = colander.SchemaNode(
        colander.String(), description='Organisation', missing='')
